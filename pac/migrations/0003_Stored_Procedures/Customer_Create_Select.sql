	...
	BEGIN
		...
		IF @CustomerID IS NULL
			BEGIN	
				...
				@ContactTitle = A.ContactTitle, @Phone = A.Phone, @Email = A.Email, @Website = A.Website, @ServicePointID = A.ServicePointID
				FROM dbo.Account A
				...
				@PostalCode, @ContactName, @ContactTitle, @Phone, @Email, @Website, @AccountID, @ServicePointID, @UpdatedBy, @Comments, @CustomerID output
			END
	END
ELSE
	BEGIN
