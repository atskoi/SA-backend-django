...
DECLARE @LaneID BIGINT;
SELECT @LaneID = ID FROM @RequestSectionLaneTableType_ID;
EXEC dbo.[Audit_Record] @TableName = 'RequestSectionLane', @PrimaryKeyValue = @LaneID, @UpdatedBy = @UpdatedBy;
