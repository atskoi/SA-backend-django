...
from pac.rrf.models import (Customer, LastAssignedUser, Request,
                            ...
                            RequestSectionLaneHistory, RequestSectionLaneImportQueue,
...
class RequestSectionLaneImportQueueSerializer(serializers.ModelSerializer):
    class Meta:
        model = RequestSectionLaneImportQueue
