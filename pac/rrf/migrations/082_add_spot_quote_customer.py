...
# Method to insert Spot Quote dummy account and customer
def insert_spot_quote_customer(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(insert_spot_quote_customer),
    ]
